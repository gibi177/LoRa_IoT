...
// Defina os pinos do módulo LoRa conforme seu hardware
#define SS 10
#define RST 9
#define DIO0 2
...
void loop() {
  ...
  float dust = random(50, 300);                     // 50 a 300 (unidade a definir)
  float battery = random(0, 10000) / 100.0;        // 0 a 100 %

  // Monta a mensagem em formato texto separado por vírgulas
  ...
  delay(30000); // espera 30 segundos antes da próxima transmissão
}
